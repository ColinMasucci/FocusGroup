...
//import teensImage from '../assets/teens_on_phones_bg.jpg';
import teensImage from '../assets/teens_on_one_phone_bg.jpg';
import logo from '../assets/logo.png';
import Button from '@mui/material/Button';

//bg-cover bg-center min-h-screen flex flex-col w-full overflow-x-hidden items-center justify-center text-white text-center p-6
const LandingPage = () => (
  ...
  <div className="w-1/2 h-full bg-gray-100 flex flex-col justify-center items-center p-8">
    ...
    <div className="flex gap-4">
      ...
      <Button variant="contained" style={{backgroundColor: '#2ac153', color: 'white'}} component={Link} to="/signin">
        Sign In
      </Button>
    </div>
  </div>
